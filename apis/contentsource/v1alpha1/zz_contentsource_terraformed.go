...
// GetInitParameters of this ContentSource
func (tr *ContentSource) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ContentSource
func (tr *ContentSource) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
