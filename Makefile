...
PROJECT_NAME ?= provider-vra8
PROJECT_REPO ?= github.com/therandombyte/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-vra_v0.9.0
...
xpkg.build.provider-vra8: do.build.images
